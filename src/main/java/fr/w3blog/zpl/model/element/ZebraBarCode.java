...
public abstract class ZebraBarCode extends ZebraElement {
    ...
    // Para QR
    Modelo modelo = Modelo.ENHANCED;
    MagnificaFactor magnificaFactor = MagnificaFactor._200;
    Correcion correcion = Correcion.HIGH;
    ...
    public ZebraBarCode(int positionX, int positionY, String text, Modelo modelo, MagnificaFactor magnificaFactor, Correcion correcion) {
        this.positionX = positionX;
        this.positionY = positionY;
        this.text = text;
        this.modelo = modelo;
        this.magnificaFactor = magnificaFactor;
    ...
    public MagnificaFactor getMagnificaFactor() {
        return magnificaFactor;
    }

    public void setMagnificaFactor(MagnificaFactor magnificaFactor) {
        this.magnificaFactor = magnificaFactor;
    }

    public Correcion getCorrecion() {
        return correcion;
    }

    public void setCorrecion(Correcion correcion) {
        this.correcion = correcion;
    }
